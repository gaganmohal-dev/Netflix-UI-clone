            ...
            {variant !== "landscape" && (
                <div className="absolute inset-0 bg-linear-to-t from-black to-transparent opacity-0 hover:opacity-100 transition duration-300">
                    ...
                    <div className="absolute bottom-15 right-2 z-35 w-12 h-12 transition delay-200 flex flex-col gap-2">
                        ...
                        <button 
                          className="w-full h-full bg-red-500/90 rounded-full cursor-pointer"
                          onClick={(e) => {
                            e.stopPropagation();
                          }}
                        >
...
//     {/* Layerign inset-0 */}
//     {variant !== "landscape" && (
//             <div className="absolute inset-0 bg-linear-to-t from-black to-transparent opacity-0 hover:opacity-100 transition duration-300"  onClick={() => 
